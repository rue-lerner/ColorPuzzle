...
- Click **New puzzle** to generate a hidden three-color recipe from that palette.
- Click color choices to fill the 50%, 30%, and 20% slots on the lower half of the wheel.
